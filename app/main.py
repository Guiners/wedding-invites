...
async def generate_invitation(
    ...
    church_google_maps_link = google_maps_link_generator(
        wedding_data.event.name_of_the_church, wedding_data.event.church_address
    )
    venue_google_maps_link = google_maps_link_generator(
        wedding_data.event.name_of_the_wedding_venue,
        wedding_data.event.wedding_venue_address,
    )
    ...
    return templates.TemplateResponse(invitation_template, template_data)
